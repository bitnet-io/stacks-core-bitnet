...
pub const MAINNET_2_0_GENESIS_ROOT_HASH: &str =
	"a1d79b3643417895a41dde6152349a53a97a53d4c1fd4179adcef620460e3bc5";

/// This is the "dummy" parent to the actual first burnchain block that we process.
pub const FIRST_BURNCHAIN_CONSENSUS_HASH: ConsensusHash = ConsensusHash([0u8; 20]);

pub const BITCOIN_MAINNET_FIRST_BLOCK_HEIGHT: u64 = 189759;

pub const BITCOIN_MAINNET_FIRST_BLOCK_TIMESTAMP: u32 = 1719008011;
pub const BITCOIN_MAINNET_FIRST_BLOCK_HASH: &str =
        "8667ad01c0fb7da91200ca0624d98701b2bfe7bbb7d96a3cc1d62d82e319a4d3";


pub const BITCOIN_MAINNET_INITIAL_REWARD_START_BLOCK: u64 = 179000;

pub const BITCOIN_MAINNET_STACKS_2_05_BURN_HEIGHT: u64 = 191_000;

pub const BITCOIN_MAINNET_STACKS_21_BURN_HEIGHT: u64 = 192_500;
