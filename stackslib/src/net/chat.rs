...
mod test {
    ...
    fn make_test_chain_dbs(
        ...
        let mut peerdb = PeerDB::connect(
            ...
            &vec![
                QualifiedContractIdentifier::parse("SS000000000000000000003E020GD.sbtc").unwrap(),
            ],
        )
        .unwrap();
        ...
        with_timeout(100, move || {
            ...
            peerdb_1
                .update_local_peer(
                    ...
                    local_peer_1.port,
                    &[
                        QualifiedContractIdentifier::parse("SS000000000000000000003E020GD.sbtc")
                            .unwrap(),
                    ],
                )
                .unwrap();
                        ...
                        if peer_1_rc_consensus_hash == peer_2_rc_consensus_hash {
                            ...
                            assert_eq!(
                                ...
                                vec![QualifiedContractIdentifier::parse(
                                    "SS000000000000000000003E020GD.sbtc"
                                )
                                .unwrap()]
                            );
