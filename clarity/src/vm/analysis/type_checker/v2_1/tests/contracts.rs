...
const SIMPLE_NAMES: &str = "(define-constant burn-address 'SS000000000000000000003E020GD)
...
fn test_names_tokens_contracts_interface() {
    const INTERFACE_TEST_CONTRACT: &str = "
        (define-constant var1 'SS000000000000000000003E020GD)
        ...
        (define-private (f08) 'SS000000000000000000003E020GD)
